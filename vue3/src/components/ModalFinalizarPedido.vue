<template>
  <v-card min-height="315px" class="bg-carrinho" >
    ...
    <v-card-subtitle class="desc-detail pl-5 mt-n2 mt-sm-0 text-subtitle-2 text-md-subtitle-1 font-italic">
    ...
    <v-card-text>
      ...
      <v-row class="d-flex flex-column">
        ...
        <v-col cols="12" class="mt-n2 mt-sm-0 desc-detail">
            ...
            <div class="pl-md-2 pl-2 text-sm-body-1 text-caption desc-detail">
        ...
        <v-col cols="12" class="d-flex flex-sm-row flex-column justify-start mt-n3 mt-sm-0">
            <v-btn color="#018749" @click="goWhats" prepend-icon="mdi-whatsapp"  size="small" class=" ml-md-0">
              <span>Enviar mensagem agora</span>
            </v-btn>
            <v-btn color="#00693E" prepend-icon="mdi-email" size="small" class="ml-sm-2 mt-2 mt-sm-0" >
