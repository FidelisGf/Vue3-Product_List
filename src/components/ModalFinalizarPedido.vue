<template>
  <v-card min-height="315px" class="bg-carrinho" >
    ...
    <v-card-title
      class="desc-detail
      text-subtitle-1
      text-md-h5 font-weight-bold mt-n6"
    >
      Pedido {{numero_pedido}} aberto com sucesso...
    </v-card-title>
    <v-card-subtitle class="desc-detail pl-5 mt-n2
    mt-sm-0 text-subtitle-2 text-md-subtitle-1 font-italic">
    ...
    <v-card-text>
      ...
      <v-row class="d-flex flex-column">
        <v-col cols="12">
          <p class=" desc-detail text-body-2 mt-n2
          mt-sm-0 text-sm-body-1 font-weight-medium">
            Quase tudo pronto. Agora nos envie o numero do
            seu pedido pelo whats ou por
            e-mail para prosseguirmos ao pagamento.
          </p>
        </v-col>
        <v-col cols="12" class="mt-n2 mt-sm-0 desc-detail">
            <p><b>Informações de contato : </b></p>
            <div class="pl-md-2 pl-2 text-sm-body-1
            text-caption desc-detail">
              <p>Numero de telefone para contato :
                <b>(45) 998463475</b>
              </p>
              <p>Endereço de email para contato :
                <b>jpinformaticafoz@gmail.com</b>
              </p>
              <p>
                <b>Informe o numero do pedido na mensagem.</b>
              </p>
            </div>
        </v-col>
